...
class Geeta37000(FSMState):
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        super().__init__()
        self.state_cmd = state_cmd
        self.policy_output = policy_output
        self.name = FSMStateName.SKILL_Geeta_37000
        self.name_str = "skill_geeta_37000"
        self.motion_phase = 0
        self.counter_step = 0
        self.ref_motion_phase = 0
        
        current_dir = os.path.dirname(os.path.abspath(__file__))
        config_path = os.path.join(current_dir, "config", "Geeta37000.yaml")
        with open(config_path, "r") as f:
            ...
            print("Geeta37000 policy initializing ...")
